...
phina.define('VisualizeRect', {
  ...
  init: function(options) {
    ...
    this.firstSize = {width: this.width, height: this.height};
    this.radian = 0;
  },
...
phina.define('MainScene', {
  ...
  createVisualiza: function(x, y) {
    ...
    for(var i=-16; i<48; i++){
      ...
      this.addVisualizeRect(x+visRecX, y+visRecY, 0.4, 0.4, i*5.625, i+16);
    ...
    for(var i=-8; i<24; i++){
      ...
      this.addVisualizeRect(x+visRecX, y+visRecY, 2, 2, i*11.25, i+8);
      //--------------------x座標, y, width, height, rotation, index番号
    }
    */
  },
